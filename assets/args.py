...
gear_css = "QPushButton { background-color: transparent;\n" \
           "border-image: url(assets/img/gear.png);\n" \
           "background: none;\n" \
           "border: none;\n" \
           "background-repeat: none; }\n" \
           "QPushButton::menu-indicator{image:none;}"

gear_focus_css = "QPushButton { background-color: transparent;\n" \
                 "border-image: url(assets/img/gear_focus.png);\n" \
                 "background: none;\n" \
                 "border: none;\n" \
                 "background-repeat: none; }\n" \
                 "QPushButton::menu-indicator{image:none;}"
